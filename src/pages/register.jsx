        ...
        <div className='bg-neutral-50 font-mono h-screen w-screen flex justify-center items-center'>
            <form autoComplete='off' onSubmit={handleSubmit} className='max-h-max h-3/5 w-2/5 bg-blue-500 flex flex-col justify-center items-center gap-4'>
                ...
                <div className='flex flex-col justify-center w-3/5 max-w-xl content-center'>
                    ...
                    <p id='userDescription' className={userFocus || !validUsername && username ? 'bg-blue-800 text-white' : 'hidden'} >Usuario deve ter pelo menos 4 digitos</p>
                    ...
                    <p id='passwordDescription' className={passwordFocus || !validPassword && password ? 'bg-blue-800 text-white' : 'hidden'} >A senha deve ter 9 digitos, deve ter pelo menos um caixa baixa, alta, número e caractere especial</p>
                    ...
                    <p id='confirmPasswordDescription' className={confirmPasswordFocus || !passwordMatch && confirmPassword ? 'bg-blue-800 text-white' : 'hidden'}>A senha deve ser igual</p>
                    <button className={buttonEnabled ? 'bg-blue-800 w-36 self-center h-10 mt-10 rounded-md hover:brightness-125 duration-100' : 'hover:cursor-not-allowed bg-blue-800 w-36 self-center h-10 mt-10 rounded-md'}>Registre-se</button>
                </div>
